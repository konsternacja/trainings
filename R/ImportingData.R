...
# CSV
rio_csv <- import("/home/konsternacja/Downloads/mbb.csv")
head(rio_csv)

mbb_csv <- read.csv("/home/konsternacja/Downloads/mbb.csv")
head(mbb_csv)
...
mbb_txt <- read.csv("/home/konsternacja/Downloads/mbb.txt")
head(mbb_txt)
...
mbb_xlsx <- read.table(file = "mbb.xlsx", 
                      sep = "\t", header=TRUE)
head(mbb_xlsx)
# DATA VIEWER ##############################################
